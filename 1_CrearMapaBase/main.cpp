...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.MapaBaseWeb", 1, 0, "MapView");

    // Register the MapaBaseWeb (QQuickItem) for QML
    qmlRegisterType<MapaBaseWeb>("Esri.MapaBaseWeb", 1, 0, "MapaBaseWeb");

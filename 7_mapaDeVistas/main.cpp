...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.mapaDeVistas", 1, 0, "MapView");

    // Register the MapaDeVistas (QQuickItem) for QML
    qmlRegisterType<MapaDeVistas>("Esri.mapaDeVistas", 1, 0, "MapaDeVistas");

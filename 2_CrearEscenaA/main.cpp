...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<SceneQuickView>("Esri.mapaDeEscenas", 1, 0, "SceneView");

    // Register the MapaDeEscenas (QQuickItem) for QML
    qmlRegisterType<MapaDeEscenas>("Esri.mapaDeEscenas", 1, 0, "MapaDeEscenas");

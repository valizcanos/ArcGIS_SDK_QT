...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.RutaCapas", 1, 0, "MapView");

    // Register the RutaCapas (QQuickItem) for QML
    qmlRegisterType<RutaCapas>("Esri.RutaCapas", 1, 0, "RutaCapas");
